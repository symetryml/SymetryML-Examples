...
SymetryML control parameter. Please consult <<../../guides/SML_Installation_Guide.adoc#about-the-symetryml-configuration, Installation Guide>> for more details on how to set these parameters. The default 
value for this `sml.task.max` parameter is 4.

Please consult the link:../kafka-stream-app.md[SML Kafka Stream Application Documentation] for details.
